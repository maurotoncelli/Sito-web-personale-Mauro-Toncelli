          ...
          <div>
            ...
            <div className="mt-1 flex flex-col items-start gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-6 py-3 text-[13px] font-semibold tracking-[0.1em] uppercase text-white transition-opacity hover:opacity-85"
              >
